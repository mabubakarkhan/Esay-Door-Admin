...
class LicenseBoxAPI {
  ...
  { 
    ...
    $this->license_file = $this->current_path.'../lic.php';
  ...
  public function verify_license($time_based_check = false, $license = false, $client = false){
    ...
    $today = date('d-m-Y');
    if(empty($_SESSION["1445065099"])){
      $_SESSION["1445065099"] = '0000-00-00';
    }
    if($type==1){
    if($today>=$_SESSION["1445065099"]){
