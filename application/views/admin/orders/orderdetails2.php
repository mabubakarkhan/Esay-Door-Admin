                                            ...
                                            <tbody>
                                                    ...
                                                    <td colspan="3">
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <strong>  <?php echo $this->lang->line("Order Date : ");?><?php echo $order->at; ?></strong>
                                                                <br />

                                                                </td>
                                                                <td>
                                                                    <strong> <?php echo $this->lang->line("Delivery Details :");?></strong><br />
                                                                    <strong>  <?php echo $this->lang->line("Contact : ");?><?php echo $order->fname.' '.$order->lname ; ?>, <br/> <?php echo $this->lang->line("Contact : ");?> <?php echo $order->phone; ?></strong>
                                                                    <br />
                                                                    <?php if ($location): ?>
                                                                        <strong>  Receiver</strong>
                                                                        <address>
                                                                            <?php echo $location->receiver_name; ?><br />
                                                                            <?php echo $location->receiver_mobile; ?>
                                                                        </address>
                                                                    <?php endif ?>
                                                                    <strong>  <?php echo $this->lang->line("Address :");?></strong>
                                                                    <address>
                                                                        <?php echo $location->city_name; ?><br>
                                                    ...
                                                    foreach($order_items as $items){
                                                        ...
                                                        <tr>
                                                            <td><?php echo $items->product_name; ?><br />
                                                                <?php if ($items->new_price > 0): ?>
                                                                    <?php echo $items->unit_value." ".$items->unit. " (".$this->config->item("currency")." $items->new_price ) "; ?>
                                                                <?php else: ?>
                                                            ...
                                                            <td>
                                                                <?php echo $items->Size ; ?> / <?php echo $items->Color ; ?>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                if ($items->new_price > 0) {
                                                                    echo $items->qty * $items->new_price;
                                                                    $total_price = $total_price + ($items->qty * $items->new_price);
                                                                }
                                                                else{
                                                                    echo $items->qty * $items->price;
                                                ...
                                                <tr>
                                                    ...
                                                    <td >
                                                        ...
                                                        <strong class=""><?=$order->total_amount?>  <?php echo $this->config->item("currency");?></strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2"><strong class="pull-right">Discount :</strong></td>
                                                    <td >
                                                        <strong class=""><?php echo $order->discount; ?> <?php echo $this->config->item("currency");?></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td >
                                                        ...
                                                        <strong class=""><?php echo $net = $order->total_amount + $order->delivery_charge - $order->discount; ?><?php echo $this->config->item("currency");?> </strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
