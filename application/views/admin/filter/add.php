            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            ...
                            ?>
                    <div class="row">
                        <form action="<?php echo site_url("admin/postfilter"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" name="admin_title" placeholder="Admin Title" class="form-control" required="required" />
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group form-button">
                                                <input type="submit" class="btn btn-fill btn-rose" value="Add Filter">
                                            </div>
                                        </div>
                                    </div>
                                </div>
