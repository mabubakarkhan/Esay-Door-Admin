            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            ...
                            ?>
                    <div class="row">
                        <form action="<?php echo site_url("admin/updatefilter"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            <input type="hidden" name="id" value="<?=$q['filter_id']?>">
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        <label class="col-md-3 ">Title For Admin *</label>
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" name="admin_title" placeholder="Admin Title" class="form-control" required="required" value="<?=$q['admin_title']?>" />
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group form-button">
                                                <input type="submit" class="btn btn-fill btn-rose" value="Update Filter">
                                            </div>
                                        </div>
                                    </div>
                                </div>
