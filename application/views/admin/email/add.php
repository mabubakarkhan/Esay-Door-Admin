            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            ...
                            ?>
                    <div class="row">
                        <form action="<?php echo site_url("admin/post_email_template"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" name="title" placeholder="Email Template Title" class="form-control" />
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <textarea name="template" class="form-control" rows="10"></textarea>
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group form-button">
                                                <input type="submit" class="btn btn-fill btn-rose" value="Add Template">
                                            </div>
                                        </div>
                                    </div>
                                </div>
