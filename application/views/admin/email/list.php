                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" style="" href="<?php echo site_url("admin/add_email_template"); ?>">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?=$q['email_template_id']?></td>
                                                    <td><?=$q['title']?></td>
                                                    <td><?=$q['template']?></td>
                                                    <td><a href="javascript://" class="btn btn-primary upload-emails-btn" data-id="<?=$q['email_template_id']?>" data-title="<?=$q['title']?>">Upload</a></td>
                                                    <td class="td-actions text-right"><div class="btn-group">
                                                            <?php echo anchor('admin/edit_email_template/'.$q['email_template_id'], '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                            <i class="material-icons">edit</i>
                                                        </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_email_template/'.$q['email_template_id'], '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
...
$(function(){
    ...
    $(document).on('click', '.upload-emails-btn', function(event) {
        event.preventDefault();
        $id = $(this).attr('data-id');
        $title = 'Upload Emails '+$(this).attr('data-title');
        $("#modal-upload-emails h4.modal-title").text($title);
        $("#modal-upload-emails input[name='email_template_id']").val($id);
        $("#modal-upload-emails").modal('show');
    });
...
<div class="modal fade" id="modal-upload-emails">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url("admin/update_email_template_contacts_bulk"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
