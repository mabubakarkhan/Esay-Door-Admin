        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                    <div class="row">
                        <form action="<?php echo site_url();?>/csv/uploadfilterstocategoriescsv/" method="post" enctype="multipart/form-data" name="form1" id="form1" class="form-horizontal" >
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Filter Upload To Categories</h4>
