                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" style="" href="<?php echo site_url("admin/addblog"); ?>">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php foreach($blog as $q){ ?>
                                                <tr>
                                                    <td><?=$q['title']?></td>
                                                    <td><?=$q['detail']?></td>

                                                    <td class="td-actions text-right"><div class="btn-group">
                                                            <?php echo anchor('admin/editblog/'.$q['blog_id'], '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                            <i class="material-icons">edit</i>
                                                        </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/deleteblog/'.$q['blog_id'], '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
