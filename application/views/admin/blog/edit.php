            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            ...
                            ?>
                    <div class="row">
                        <form action="<?php echo site_url("admin/updateblog"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            <input type="hidden" name="id" value="<?=$q['blog_id']?>">
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" name="title" placeholder="Title" class="form-control" required="required"  value="<?=$q['title']?>" />
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 50px">
                                        <label class="col-md-3 ">Short Heading *</label>
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <textarea name="short" rows="2" class="form-control" placeholder="Short Heading" required="required"><?=$q['short']?></textarea>
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <textarea name="detail" id="detail" rows="5" class="form-control" placeholder="Detail" required="required"><?=$q['detail']?></textarea>
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                    <img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/category/'.$q['image'] ?>" />
                                                </div>
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" name="meta_title" placeholder="Meta Title" class="form-control" value="<?=$q['meta_title']?>" />
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" name="meta_key" placeholder="Meta Key Words" class="form-control" value="<?=$q['meta_key']?>" />
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" name="meta_desc" placeholder="Meta Description" class="form-control" value="<?=$q['meta_desc']?>" />
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group form-button">
                                                <input type="submit" class="btn btn-fill btn-rose" value="Update Blog">
                                            </div>
                                        </div>
                                    </div>
                                </div>
