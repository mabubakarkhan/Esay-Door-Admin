                                                  ...
                                                  foreach($users as $user)
                                                  {
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $user->restaurant_type; ?></td> 
                                                            <td>
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        <td>Min Order</td>
                                                                        <td><?=$user->min_order?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>D-charges</td>
                                                                        <td><?=$user->delivery_charges?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Open</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>O-Discount</td>
                                                                        <td><?=$user->own_discount?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>A-Discount</td>
                                                                        <td><?=$user->admin_discount?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td class="td-actions text-right">
                                                                <div class=""><?php echo anchor('admin/edit_restaurant/'.$user->user_id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round"><i class="material-icons">edit</i></button>', array("class"=>"")); ?></div>
                                                                <br><a href="http://localhost/OnlineStoreMain/admin-login/<?=$user->user_phone?>/<?=$user->user_password?>/" target="_blank" class="btn btn-success btn-round">Login</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                  }
