                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Delivery Charge </label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $ct->delivery_charge; ?></td>
                                                    <td class="text-center">
                                                        <?php echo anchor('admin/edit_city/'.$ct->city_id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
