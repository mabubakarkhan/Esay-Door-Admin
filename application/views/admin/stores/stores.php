                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" style="" href="<?php echo site_url("admin/addstore"); ?>">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center"><?php echo $store->store_id; ?></td>
                                                    <td><?php echo $store->title; ?></td>

                                                    <td class="td-actions text-right"><div class="btn-group">
                                                            <?php echo anchor('admin/editstore/'.$store->store_id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                            <i class="material-icons">edit</i>
                                                        </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/deletestore/'.$store->store_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
