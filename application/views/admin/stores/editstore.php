                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit Store</h4>
                                        <div class="row" style="margin-top: 50px">
                                            <label class="col-md-3">Store Title *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="title" class="form-control" value="<?php echo $store->title; ?>"/>
                                                    <input type="hidden" name="store_id" class="form-control" value="<?php echo $store->store_id; ?>"/>
                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="lat" placeholder="Store Google Latitude" class="form-control" value="<?php echo $store->lat; ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="long" placeholder="Store Google Longitude" class="form-control" value="<?php echo $store->long; ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Store Image</label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/category/'.$store->image ?>" />
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="savestore" value="Save store">
                                                </div>
                                            </div>
                                        </div>
                                </div>
