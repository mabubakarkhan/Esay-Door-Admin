                                ...
                                <div class="card-content">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php foreach($ads as $key => $q){ ?>
                                                    <tr>
                                                        <td><?=$q['title']?></td>
                                                        <td><img src="<?=$this->config->item('base_url').'uploads/ad/'.$q['image']?>" width="100" /></td>
                                                        <td>
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" name="status" disabled <?php if($q['status']=='active'){ echo "checked"; } ?>>
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php echo anchor('admin/edit_ad/'.$q['ad_id'], '<button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="Edit">
