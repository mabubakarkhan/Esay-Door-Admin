            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            ...
                            ?>
                    <div class="row">
                        <form action="<?=site_url("admin/post_admin_pro")?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            <div class="col-md-9">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <h4 class="card-title">Add product to <?=$cat->name?></h4>
                                        <input type="hidden" name="category_id" value="<?=$cat->admin_category_id?>" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose"  value="Add Product">
                                                </div>
                                            </div>
                                        </div><!-- {row} -->
                                    </div>
