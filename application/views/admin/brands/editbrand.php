                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit Brand</h4>
                                        <div class="row" style="margin-top: 50px">
                                            <label class="col-md-3">Brand Title *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="title" class="form-control" value="<?php echo $brand->title; ?>"/>
                                                    <input type="hidden" name="brand_id" class="form-control" value="<?php echo $brand->brand_id; ?>"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 50px">
                                            <label class="col-md-3">Brand Title Urdu</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="urdu_title" class="form-control" value="<?php echo $brand->urdu_title; ?>" style="text-align: right;"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" >
                                            <label class="col-md-3 label-on-left">Categories</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <select class="text-input form-control" name="categories[]" multiple="multiple">
                                                        <option value="0"> No Category</option>
                                                        <?php
                                                        $categories = explode(',', $brand->categories);
                                                        echo printCategory(0,0,$this,$categories);
                                                        function printCategory($parent,$leval,$th, $categories2){
                                                        ...
                                                        foreach($rows as $row){
                                                            if ($row->count > 0) {
                                                                        ...
                                                                        printRow($row,true,$categories2);
                                                                        printCategory($row->id, $leval + 1,$th,$categories2);
                                                                        
                                                                    } elseif ($row->count == 0) {
                                                                        printRow($row,false,$categories2);
                                                                        //print_r($row);
                                                                    }
                                                            }
                                                        ...
                                                        function printRow($d,$bool, $categories_){
                                                        ?>
                                                            <?php if (in_array($d->id, $categories_)): ?>
                                                                <option value="<?php echo $d->id; ?>" selected='selected' ><?php for($i=0; $i<$d->leval; $i++){ echo "_"; } echo $d->title; ?></option>
                                                            <?php else: ?>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Brand Logo </label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/category/'.$brand->image ?>" />
                                                    </div>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Brand Second Logo </label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/category/'.$brand->logo_2 ?>" />
                                                    </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail"></div>
                                                    <div>
                                                        <span class="btn btn-rose btn-round btn-file">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Brand Banner </label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/category/'.$brand->banner ?>" />
                                                    </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail"></div>
                                                    <div>
                                                        <span class="btn btn-rose btn-round btn-file">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="savebrand" value="Save Brand">
                                                </div>
                                            </div>
                                        </div>
                                </div>
