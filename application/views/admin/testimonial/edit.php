            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            ...
                            ?>
                    <div class="row">
                        <form action="<?php echo site_url("admin/updatetestimonial"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            <input type="hidden" name="id" value="<?=$q['testimonial_id']?>">
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <textarea name="detail" rows="5" class="form-control" placeholder="Detail" required="required"><?=$q['detail']?></textarea>
                                            <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 label-on-left">User Image </label>
                                        <div class="col-md-9">
                                            <legend></legend>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group form-button">
                                                <input type="submit" class="btn btn-fill btn-rose" value="Update Testimonial">
                                            </div>
                                        </div>
                                    </div>
                                </div>
