                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" style="" href="<?php echo site_url("admin/addtestimonial"); ?>">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right"><div class="btn-group">
                                                            <?php echo anchor('admin/edittestimonial/'.$q['testimonial_id'], '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                            <i class="material-icons">edit</i>
                                                        </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/deletetestimonial/'.$q['testimonial_id'], '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
