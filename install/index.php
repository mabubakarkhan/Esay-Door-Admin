        ...
        <div class="box">
          ...
          <form action="index.php?step=0" method="POST">
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="enter your purchase/license code 1" name="license" required>
              </div>
            </div>
            <div class="field">
              <label class="label">Your name</label>
              <div class="control">
                <input class="input" type="text" placeholder="enter your name/envato username 1" name="client" required>
              </div>
            </div>
            <div style='text-align: right;'>
          ...
          <form action="index.php?step=0" method="POST">
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="enter your purchase/license code 2" name="license" required>
              </div>
            </div>
            <div class="field">
              <label class="label">Your name</label>
              <div class="control">
                <input class="input" type="text" placeholder="enter your name/envato username 2" name="client" required>
              </div>
            </div>
            <div style='text-align: right;'>
              <button type="submit" class="button is-link">Verify</button>
...
$config["base_url"] = "'.$base.'";', FILE_APPEND | LOCK_EX);
          ...
          <center>
              <p>
                  <strong>Application is successfully installed.</strong>
              </p>
              <br>
              <a href="../index.php" class="button is-link gen-env">Admin Panel</a>
              <a href="../store" class="button is-link gen-env">Store Panel</a>
          </center>
          <?php
          }
          else
